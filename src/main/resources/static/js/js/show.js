    ...
    function putInArticle(data) {
        $('.kira-article-top').html('');
        $('.kira-article-footer').html('');
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- kira</span>' +
            '</div>');
        $('.kira-article-top').append(articleTop);
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="https://kira-blog.oss-cn-hangzhou.aliyuncs.com/logo1.jpg/weixin.jpg">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信公众号：kiraocean1314</p>' +
            ...
            '</span>' +
            '</div>');
        $('.kira-article-footer').append(articleFooter);
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="https://www.kiraocean.cn/article/' + data.articleId  + '"  data-title="' + data.articleTitle + '">' +
    ...
    $.ajax({
        ...
        success:function (data) {
            if(data['status'] == 0){
                ...
                $('.content').html('');
                var error = $('<div class="article"><div class="kira-article-top"><div class="error">' +
                    '<img src="https://kira-blog.oss-cn-hangzhou.aliyuncs.com/logo1.jpg/register_success.jpg">' +
                    '<p>没有找到这篇文章哦</p>' +
                    '<p>可能不小心被博主手残删掉了吧</p>' +
                    '<div class="row">' +
                    '<a href="/">返回首页</a>' +
