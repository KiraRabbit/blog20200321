    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://kira-blog.oss-cn-hangzhou.aliyuncs.com/logo1.jpg/qq_code.png");
        $('.weixin_code').attr("src","https://kira-blog.oss-cn-hangzhou.aliyuncs.com/logo1.jpg/weixin_code.png");
    });
